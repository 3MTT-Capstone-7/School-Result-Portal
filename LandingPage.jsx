  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans flex flex-col justify-between">
      ...
      <header className="bg-white border-b border-[#E2E8F0] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-[#2563EB] font-semibold hover:text-[#1D4ED8] transition-colors">
                Home
              </a>
              <a href="#" className="text-[#64748B] hover:text-[#0F172A] font-medium transition-colors">
                About
              </a>
              <a href="#" className="text-[#64748B] hover:text-[#0F172A] font-medium transition-colors">
                Contact
              ...
              <a 
                href="#" 
                className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white px-5 py-2 rounded-md font-medium transition-colors shadow-sm"
              >
                Login
              </a>
            </nav>
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="text-[#64748B] hover:text-[#0F172A] focus:outline-none p-2"
        ...
        {isMenuOpen && (
          <nav className="md:hidden bg-white border-b border-[#E2E8F0] px-4 pt-2 pb-4 space-y-3">
            <a href="#" className="block text-[#2563EB] font-semibold">Home</a>
            <a href="#" className="block text-[#64748B] font-medium">About</a>
            <a href="#" className="block text-[#64748B] font-medium">Contact</a>
            <a 
              href="#" 
              className="inline-block w-full text-center bg-[#2563EB] text-white py-2 rounded-md font-medium"
            >
              Login
            </a>
          </nav>
